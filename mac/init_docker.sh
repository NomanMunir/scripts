...
alias init_docker="~/./init_docker.sh"
#
#
# Vagrant

export VAGRANT_HOME="/Users/nmunir/goinfre/vagrant"

# Docker Compose Aliases
alias dc="docker-compose"                     # Short for docker-compose
...
alias dcr="docker-compose run"                # Run a one-off command
...
alias dcp="docker-compose ps"                 # List containers
alias dcrm="docker-compose rm -f"             # Remove stopped containers
alias dcre="docker-compose restart"           # Restart services
alias dcs="docker-compose stop"               # Stop services
alias dcss="docker-compose start"             # Start stopped services

source /Users/nmunir/.docker/init-zsh.sh || true # Added by Docker Desktop
